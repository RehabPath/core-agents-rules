---
description: Atomic Design component guidelines - when to extract, hierarchy, file structure. File and folder structure for atomic design components
...
Always import directly from the source file. No barrel files with runtime exports (enforced by [barrel-files rule](./barrel-files.md)).

...
- ❌ Fixing the code before writing a failing test
- ❌ Writing tests after the fix is already in place
- ❌ Using made-up test data instead of actual failing values from the ticket
- ❌ Making unrelated changes while fixing the bug
- ❌ Skipping regression testing on related tests

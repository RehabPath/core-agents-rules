---
globs: **/utils/checks.util.test.ts
description: Testing patterns specifically for utility functions and type guards
---

# Utility Function Testing Patterns

Extends the general [unit-test.mdc](./unit-test.md) guidelines with specific patterns for utility functions.

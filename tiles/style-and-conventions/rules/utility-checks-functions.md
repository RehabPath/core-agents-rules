---
globs: **/utils/checks.util.ts
description: Guidelines for creating checks
---
...
Follow the established `unit-test` patterns from the `recovery/testing` tile for test structure.
